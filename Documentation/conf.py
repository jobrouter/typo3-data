...
htmlhelp_basename = 'TYPO3JobRouterDatadoc'
...
latex_documents = [
    (master_doc, 'TYPO3JobRouterData.tex', u'TYPO3 JobRouter Data Documentation',
...
man_pages = [
    (master_doc, 'typo3jobrouterdata', u'TYPO3 JobRouter Data Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TYPO3JobRouterData', u'TYPO3 JobRouter Data Documentation',
     author, 'TYPO3JobRouterData', 'One line description of project.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {
    ...
    't3coreapi': ('https://docs.typo3.org/m/typo3/reference-coreapi/11.5/en-us/', None),
